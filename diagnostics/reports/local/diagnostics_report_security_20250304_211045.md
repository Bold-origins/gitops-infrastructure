# Security & Policy Diagnostic Report - Tue Mar  4 21:10:45 CET 2025

## OPA Gatekeeper Status
```
NAME                                             READY   STATUS    RESTARTS        AGE
gatekeeper-audit-7f54f98bbc-ztwf6                1/1     Running   7 (5h15m ago)   10h
gatekeeper-controller-manager-5c87d9b9b4-7r9pz   1/1     Running   7 (5h15m ago)   10h
```
...
example       example-network-policy   app=example-app,part-of=example   23h
