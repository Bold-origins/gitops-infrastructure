# Security & Policy Diagnostic Report - Tue Mar  4 19:16:37 CET 2025

## OPA Gatekeeper Status
```
NAME                                             READY   STATUS    RESTARTS        AGE
gatekeeper-audit-7f54f98bbc-ztwf6                1/1     Running   7 (3h21m ago)   8h
gatekeeper-controller-manager-5c87d9b9b4-7r9pz   1/1     Running   7 (3h21m ago)   8h
```
...
example       example-network-policy   app=example-app,part-of=example   21h
flux-system   allow-egress             <none>                            9h
flux-system   allow-scraping           <none>                            9h
flux-system   allow-webhooks           app=notification-controller       9h
```
